...
*2) Sales in December is much higher than any other month. So, I  considered sales of that month as an outlier and since outlier affects any forecasting model, I removed all other sales and started from Oct 2000  to get an accurate forecast.*
